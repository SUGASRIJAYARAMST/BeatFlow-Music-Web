...
import { createSong, createSongWithUrls, updateSong, deleteSong } from "../controllers/song.controller.js";
import {
  createAlbum,
...
router.put("/songs/:id", protectRoute, requireAdmin, updateSong);
